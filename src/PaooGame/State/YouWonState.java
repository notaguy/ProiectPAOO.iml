...
public class YouWonState extends State{
    ...
    public YouWonState(Handler handler){
        ...
        uiManager3.addObject(new UIImageButton(200, 500, 180, 100, Assets.button_start, new ClickListener() {
            @Override
        ...
        uiManager3.addObject(new UIImageButton(420, 500, 180, 100, Assets.button_exit, new ClickListener() {
            @Override
            public void onClick() {
                System.exit(0);
            }
    ...
    public void Draw(Graphics g) {
        ...
        g.setColor(white);
        drawString(g,"Felicitari, ai castigat!", 250,400);
